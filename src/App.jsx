          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 relative">
              ...
              <p className="text-lg text-gray-300 leading-relaxed relative z-10">
                Apasionado por <span className="text-blue-400 font-semibold">Unreal Engine</span> desde 2021, hace ya más de <span className="text-purple-400 font-semibold">4 años</span>, me he sumergido en el desarrollo de
                experiencias interactivas y entornos virtuales inmersivos.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed relative z-10">
